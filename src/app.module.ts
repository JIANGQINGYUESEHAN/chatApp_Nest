...
@Module({
  imports: [DatabaseModule.forRoot(TypeOrmOptions()), ChatModule,TypeOrmModule.forFeature([UserEntity,FriendEntity,GroupEntity,GroupRelationEntity,GroupMessageEntity,FriendMessageEntity]), 
  ...
  exports: [...Object.values(services), DatabaseModule.forRepository([UserRepository,FriendRepository,FriendRepository,GroupRepository,GroupRelationRepository, GroupMessageRepository ,FriendMessageRepository])],
