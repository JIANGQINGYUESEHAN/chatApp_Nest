import { DataSource, ObjectLiteral, ObjectType, Repository, TreeRepository } from "typeorm";
...
export const DefaultAvatarImage='http://zy.img.qiuyue.space/QQ%E5%9B%BE%E7%89%8720230516221819.jpg'