import { Controller, Get, UseGuards, Param, Post, Body, SetMetadata, Query } from '@nestjs/common';
...
export class MessageController {
  ...
  @UseGuards(FriendGuard)
  @Post("/friendMsg/:id")
  sendFriendMessage(@ReqUser() userId, @Param() friendId: FriendIdDto, @Body() friendMsg: MsgDto) {

    return this.messageService.sendFriendMessage(userId, friendId.id, { ...friendMsg })
  ...
  @UseGuards(GrouperGuard)
  @Post("/group/:id")
  async sendGroupMsg(@ReqUser() userId, @Param() groupId:  DeleteGroup, @Body() groupMsg: MsgDto){
    return this.messageService.sendGroupMessage(userId, groupId.id, { ...groupMsg });
  }
