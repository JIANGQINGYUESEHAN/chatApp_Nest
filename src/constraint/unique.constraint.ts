...
export class IsUniqueConstraint implements ValidatorConstraintInterface {
    ...
    async validate(value: any, args?: ValidationArguments) {
        ...
        try {
            ...
            let result = await item.createQueryBuilder().where({ [condition.property]: value }).getOne()
 ...
 * @returns 
 */
export function IsUnique(param: ObjectType<any> | Condition, args?: ValidationOptions) {
    /**
